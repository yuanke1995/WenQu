 ...
 * <p>
 * 由参考实现的 models_knowledge 中 KnowledgeGraphEntityMention 逐字段翻译（字段名照搬，类型做 Java 映射）。
 */
@Data
@TableName("knowledge_graph_entity_mentions")
public class KnowledgeGraphEntityMention {

    @TableId(value = "id", type = IdType.AUTO)
    private Integer id;  // 主键
    @TableField("entity_id")
    private String entityId;  // 外键 → knowledge_graph_entities.entity_id，非空
    @TableField("kb_id")
