...
async (page) => {
  ...
  await page.screenshot({ path: '/tmp/wenqu-schedule-light.png' })
  await page.evaluate(() => document.documentElement.classList.add('dark'))
  await page.screenshot({ path: '/tmp/wenqu-schedule-dark.png' })
  ...
  await page.screenshot({ path: '/tmp/wenqu-schedule-narrow.png' })
