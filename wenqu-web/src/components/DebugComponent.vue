      ...
      <div class="storage-modal-form">
        <div class="form-item">
          ...
          <a-input
            ...
            placeholder="例如: theme / wenqu_custom_config"
          />
        </div>
...
function downloadLogs() {
  ...
  a.href = url
  a.download = `wenqu-api-log-${dayjs().format('YYYYMMDD_HHmmss')}.log`
  a.click()
...
const systemKeyPrefixes = ['user_token', 'wenqu_', 'theme', 'vueuse', 'loglevel']
