...
const rememberRemoteSource = (source) => {
  ...
  localStorage.setItem('wenqu_remote_repo_history', JSON.stringify(history))
}
...
const loadHistory = () => {
  try {
    const raw = localStorage.getItem('wenqu_remote_repo_history')
    if (raw) {
...
const deleteHistoryItem = (item) => {
  ...
  localStorage.setItem('wenqu_remote_repo_history', JSON.stringify(repoHistory.value))
}

const clearAllHistory = () => {
  repoHistory.value = []
  localStorage.removeItem('wenqu_remote_repo_history')
